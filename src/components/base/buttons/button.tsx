...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                "bg-brand-solid text-dark shadow-xs-skeuomorphic ring-1 ring-transparent ring-inset hover:bg-brand-solid_hover data-loading:bg-brand-solid_hover",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Icon styles
                "*:data-icon:text-dark/60 hover:*:data-icon:text-dark/70",
            ].join(" "),
        },
        secondary: {
            root: [
